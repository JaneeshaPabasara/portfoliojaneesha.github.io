...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-hero relative overflow-hidden">
      ...
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-primary-light/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-3 mb-8 justify-center lg:justify-start">
              {['UI/UX Design', 'Wireframing', 'Prototyping', 'Visual Design'].map((skill) => (
                <span 
                  key={skill}
                  className="px-4 py-2 bg-secondary text-secondary-foreground rounded-full text-sm font-medium shadow-soft"
                >
                  {skill}
                </span>
              ))}
          ...
          <div className="flex justify-center lg:justify-end animate-scale-in" style={{ animationDelay: '0.3s' }}>
            <div className="relative">
              ...
              <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-primary-light rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
            </div>
          </div>
        </div>
      </div>
