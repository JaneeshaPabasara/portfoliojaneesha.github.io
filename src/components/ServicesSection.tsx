  ...
  return <section id="services" className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {services.map((service, index) => <Card key={index} className="p-8 shadow-soft hover-lift transition-all duration-300 hover:shadow-medium animate-scale-in overflow-hidden relative group" style={{
          animationDelay: `${index * 0.1}s`
              ...
              <div className="relative z-10">
                ...
                {/* CTA */}
                <Button variant="outline" className="w-full group/btn border-primary text-primary hover:bg-primary hover:text-white transition-all duration-300" onClick={scrollToContact}>
                  Get Started
        ...
        animationDelay: '0.8s'
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            step: '02',
            title: 'Design',
            desc: 'Creating wireframes and visual concepts'
          }, {
            step: '03',
            title: 'Prototype',
            desc: 'Building interactive experiences'
          }, {
            step: '04',
            title: 'Deliver',
            desc: 'Final designs and ongoing support'
        ...
        <div className="text-center mt-16">
          ...
          <Button size="lg" onClick={scrollToContact} className="bg-gradient-primary hover:opacity-90 text-white shadow-medium hover-lift">
